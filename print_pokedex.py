    ...
    try:
        ...
        for parte, datos in pokemon_combinado.items():
            ...
            def mostrar_imagen(index):
                global imagen_tk, current_image_index, etiqueta_imagen, etiqueta_tipo, etiqueta_nombre, etiqueta_current
                
                try:
                    # Limpiar widgets anteriores
                    if 'etiqueta_imagen' in globals():
                        etiqueta_imagen.pack_forget()
                    if 'etiqueta_tipo' in globals():
                        etiqueta_tipo.pack_forget()
                    if 'etiqueta_nombre' in globals():
                        etiqueta_nombre.pack_forget()
                    if 'etiqueta_current' in globals():
                        etiqueta_current.pack_forget()
                    ...
                    if current_image_index == 0:
                        etiqueta_current = tk.Label(root, text="Cuerpo Superior", font=('Arial', 22), fg="red")
                    elif current_image_index == 1:
                        etiqueta_current = tk.Label(root, text="Cuerpo Inferior", font=('Arial', 22), fg="red")
                    elif current_image_index == 2:
                        etiqueta_current = tk.Label(root, text="Cabeza", font=('Arial', 22), fg="red")
                    elif current_image_index == 3:
                        etiqueta_current = tk.Label(root, text="Cola", font=('Arial', 22), fg="red")
                    elif current_image_index == 4:
                        etiqueta_current = tk.Label(root, text="Patas Traseras", font=('Arial', 22), fg="red")
                    elif current_image_index == 5:
                        etiqueta_current = tk.Label(root, text="Patas Delanteras", font=('Arial', 22), fg="red")
                    elif current_image_index == 6:
                        etiqueta_current = tk.Label(root, text="Ojos", font=('Arial', 22), fg="red")
                    elif current_image_index == 7:
                        etiqueta_current = tk.Label(root, text="Boca", font=('Arial', 22), fg="red")
                    elif current_image_index == 8:
                        etiqueta_current = tk.Label(root, text="Orejas", font=('Arial', 22), fg="red")
                    elif current_image_index == 9:
                        etiqueta_current = tk.Label(root, text="Detalles", font=('Arial', 22), fg="red")
                    elif current_image_index == 10:
                        etiqueta_current = tk.Label(root, text="Color", font=('Arial', 22), fg="red")
                    else:
                        etiqueta_current = tk.Label(root, text=" ")
                    etiqueta_current.pack()
                    ...
                    # Abrir datos pokémon
                    etiqueta_nombre = tk.Label(root, text=lista_nombres[index], font=('Arial', 22, 'bold'))
                    etiqueta_nombre.pack()

                    etiqueta_tipo = tk.Label(root, text=f"Tipo: {lista_tipos[index]}", font=('Arial', 14))
                    etiqueta_tipo.pack()
